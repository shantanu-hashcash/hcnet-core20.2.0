...
class QuorumIntersectionCheckerImpl : public hcnet::QuorumIntersectionChecker
{
    ...
    std::optional<hcnet::Config> const mCfg;
    ...
    // reporting.
    mutable std::pair<std::vector<hcnet::NodeID>,
                      std::vector<hcnet::NodeID>>
        mPotentialSplit;
    ...
    std::vector<hcnet::NodeID> mBitNumPubKeys;
    std::unordered_map<hcnet::NodeID, size_t> mPubKeyBitNums;
    QGraph mGraph;
    ...
    void
    buildGraph(hcnet::QuorumIntersectionChecker::QuorumSetMap const& qmap);
    void buildSCCs();
    ...
    mutable hcnet::RandomEvictionCache<BitSet, bool, BitSet::HashFunction>
        mCachedQuorums;
  ...
  public:
    QuorumIntersectionCheckerImpl(
        hcnet::QuorumIntersectionChecker::QuorumSetMap const& qmap,
        std::optional<hcnet::Config> const& cfg,
        std::atomic<bool>& interruptFlag, bool quiet = false);
    bool networkEnjoysQuorumIntersection() const override;

    std::pair<std::vector<hcnet::NodeID>, std::vector<hcnet::NodeID>>
